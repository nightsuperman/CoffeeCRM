    ...
    public partial class addOther : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                connect.Open();
                OleDbCommand command1 = new OleDbCommand("INSERT INTO [Другие] (Название, Тип, Описание, Вес, Цена, Картинка) VALUES('" + textBox1.Text + "','" + comboBox1.Items[comboBox1.SelectedIndex] + "', '" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + openFileDialog1.FileName + "'); ", connect);
