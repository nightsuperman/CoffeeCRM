    ...
    public partial class addPizza : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                connect.Open();
                OleDbCommand command1 = new OleDbCommand("INSERT INTO Пица (Название, Вес, Описание, Цена, Картинка) VALUES('" + textBox1.Text + "','" + textBox2.Text + "', '" + textBox3.Text + "','" + textBox4.Text + "','" + openFileDialog1.FileName + "'); ", connect);
